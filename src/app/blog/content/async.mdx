...
We underestimate the cost of interruption. A [study showed](https://dl.acm.org/doi/abs/10.1145/1357054.1357072) that it takes roughly 23 minutes to get back to work after interruption. I'd argue that this is even higher for deep work. In addition to opportunity cost, the time that the participants could have spent on other work.
