...
<GoodBadExamples
  ...
  good={
    <SlackMessage name="Alice">
      <p>Hi team,</p>
      <p>
        <span className="font-medium">Recommendation:</span> Improve customer
      ...
      <ul>
        ...
        <li>
          <span>
            ...
            <span className="font-medium">3×</span> more likely to stay beyond 6
            months.
          </span>
        </li>
        <li>
          <span>
            ...
            <span className="font-medium">40%</span> after guided onboarding was
            introduced in our test group.
          </span>
        </li>
      </ul>
      <p>
        <span className="font-medium">How did we arrive at this?</span>
      </p>
      <ul>
        <li>
          <span>
