...
export const AgentNode = memo(function AgentNode({
  ...
  return (
    <div className="relative group w-full h-full flex flex-col">
      ...
      <div
        className={cn(
          "w-full h-full overflow-hidden bg-white dark:bg-neutral-900 rounded-xl transition-all border border-border",
          isTitleCard ? "relative" : "flex flex-col",
          selected
      ...
      >
        ...
        {isTitleCard ? (
          ...
          <>
            ...
            {/* Gradient overlay with editable title */}
            <div className="absolute bottom-0 inset-x-0 px-3 pb-2.5 pt-10 bg-gradient-to-t from-black/65 to-transparent z-10 pointer-events-none">
              <span
                ref={(el) => {
                  titleRef.current = el;
                  if (el && !isTitleFocused) el.textContent = data.title ?? "";
                }}
                ...
                className={cn(
                  "block text-sm font-semibold text-white outline-none empty:before:content-['Untitled'] empty:before:text-white/50 min-w-0 break-words drop-shadow pointer-events-auto",
